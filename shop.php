        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><img src="assets/img/android-chrome-192x192.png" class="logo" alt=""></a>
                </div>
            ...
            <div class="side">
                ...
                <li class="cart-box">
                    <ul class="cart-list">
                        <li>
                            <a href="#" class="photo"><img src="assets/img/ActaDivorcio.jpg" class="cart-thumb" alt="" /></a>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <div class="type-lb">
                                                        <p class="sale">$50.00</p>
                                                    </div>
                                                    <img src="assets/img/ServicioNacimiento.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                            <li>
                                                                <a target="_blank" href="http://www.facebook.com/sharer.php?u=https://tramitesdigitalesmexico.com/"><img src="images/fb icon.svg" alt="" style="fill: white;"></a>
                                                            </li>
                                                            <li><a target="_blank" href="https://api.whatsapp.com/send?phone=+529931784422&text=Hola%20visita%20la%20p%C3%A1gina%20https://tramitesdigitalesmexico.com/" data-toggle="tooltip" data-placement="right" title="Comparte por WhatsApp">
                                                                <img src="assets/img/WhatsApp.svg">
                                                            </a></li>
                                                            <li><a href="https://m.me/XYZ" data-toggle="tooltip" data-placement="right" title="Add to Wishlist"><img src="assets/img/Messenger.svg"></a></li>
                                                        </ul>
                                                        <a class="cart" href="shop-detail.html">Comprar ahora</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    <a class="btn hvr-hover" href="#">Comprar ahora</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
